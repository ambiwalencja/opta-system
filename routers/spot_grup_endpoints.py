...
def create_spotkanie_grupowe(request: SpotkanieGrupoweUpdate, id_spotkania: int = FastapiQuery(...),  db: Session = Depends(get_db), current_user: User = Depends(get_user_from_token("access_token"))):
